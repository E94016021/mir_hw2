...
def fff_get_two_tempo(D, t, sr_new):
    peaks = scipy.signal.find_peaks_cwt(D[40:, t], widths=np.arange(1, 10))
    ...
    for diff in range(2, 5):
                ...
                try:
                    ...
                    for file_number in range(rng_h, rng_t):
                        ...
                        try:
                            ...
                            t_1_ori, t_2_ori = f_get_two_tempo_total(tempo_list, tempo_cnt)
                            ...
                            print("gt = %3.d" % gt, ", t1 = %8.4f" % t_1, ", t2 = %8.4f" % t_2, end=' . ')
                            ...
                            print("avg.P-score = %4.4f" % p_overall, end=' , ')
                            print("ALOTC-score=", alotc, end=' ')
                            if alotc != 0:
                                print("*")
                            else:
                                print(" ")
                    ...
                    genres_pscore[g_id] = pscore_g / success_cnt
                    genres_ALOTC[g_id] = alotc_g / success_cnt
                    print("- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - "
                          "- - - - - - - - - - - - -",
                          "P-score = %4.4f" % genres_pscore[g_id], "alotc = %4.4f" % genres_ALOTC[g_id]
                          , "\n")
                    g_id += 1
        ...
        for genre_idx in range(len(genres)):
            print("%15s" % genres[genre_idx],
                  ": avg.P-score = %4.4f" % genres_pscore[genre_idx],
                  ", avg.ALOTC =", genres_ALOTC[genre_idx])
